...
def return_clean_symbol_list(symbols:str, separator:str):
    ...
    symbol_list = build_number_system.separate_symbols(symbols, separator)
    ...
    while build_number_system.check_for_no_duplicate_symbols(symbol_list):
    ...
    while build_number_system.check_for_no_double_symbols(symbol_list):
...
def play_game(play="y"):
    ...
    opening_message = get_opening_message("game_opening_message.txt")
    ...
    value_map = build_number_system.create_value_map(symbol_list)
